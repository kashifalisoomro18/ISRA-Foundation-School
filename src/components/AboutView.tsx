      ...
      {expanded && (
        ...
        >
          {PRINCIPAL_FULL_MESSAGE.split('\n\n').map((para, i) => (
            <p key={i} className="text-slate-600 leading-relaxed text-base mt-4">{para}</p>
          ))}
        </motion.div>
      )}
      <button
    ...
    font-weight:700;
      ...
      <section
        ...
        <div
          ...
          style={{
            background: "linear-gradient(160deg, rgba(10,24,58,0.88) 0%, rgba(10,24,58,0.72) 60%, rgba(10,24,58,0.82) 100%)",
          }}
        />
      ...
      <section id="about-story" className="py-16 sm:py-20 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-5 -right-5 bg-[#F5C330] text-[#0d1f3c] rounded-xl px-6 py-4 shadow-xl">
      ...
      ============================================================ */}
      <div>
        <section id="accreditations" className="accred-banner py-20 px-6 lg:px-12 min-h-[240px] flex items-center">
      ...
      ============================================================ */}
      <section id="principal-message" className="py-0 bg-white overflow-hidden">
        <style>{`
          .pm-square-wrap {
            position: relative;
          ...
          .pm-expand-btn:hover {
            background: #F5C330;
            transform: translateY(-2px);
            box-shadow: 0 8px 24px rgba(245,195,48,0.3);
          }
        `}</style>
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
                ...
                <span style={{ color: "#60BADC", fontSize: "0.72rem", fontWeight: 800, letterSpacing: "0.18em", textTransform: "uppercase" }}>
      ...
      >
        ...
        >
          {[
            { icon: Calendar, value: "2016", suffix: "", label: "Year Founded", highlight: false },
            { icon: Users, value: "1,200", suffix: "+", label: "Students Enrolled", highlight: false },
            { icon: Globe, value: "2", suffix: "", label: "Affiliations", highlight: true },
            { icon: Star, value: "10", suffix: "+", label: "Events & Programs", highlight: false },
          ].map((item, idx, arr) => {
            const Icon = item.icon;
            ...
            return (
              ...
              >
                ...
                >
                  {item.value}
                  <span style={{ color: "#F5C330" }}>{item.suffix}</span>
                </p>
      ...
      <section id="management-board" className="py-16 sm:py-20 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <span style={{ display: "inline-block", color: "#00000098", fontSize: "0.7rem", fontWeight: 800, padding: "4px 14px", borderRadius: "10px", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "14px", }}>
              Leadership</span>
      ...
      ============================================================ */}
      <section className="stats-section relative py-16 sm:py-20 px-6 lg:px-12 overflow-hidden">
        {/* Background image */}
        <div className="absolute inset-0">
          ...
          />
          {/* Overlay for text readability — adjust opacity/color to match your theme */}
          <div className="absolute inset-0 bg-[#0d1f3c]/80" />
          {/* Optional: subtle gradient so bottom/top blend with adjacent sections */}
      ...
      <section id="academic-faculty" className="py-16 sm:py-20 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-10">
            <div className="flex gap-2 bg-[#0d1f3c] p-1.5 rounded-xl">
              <button
